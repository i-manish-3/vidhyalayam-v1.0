  ...
  try {
    ...
    const response = {
      student: {
        ...
        address: admission?.address ?? student.address,
        city: admission?.city ?? student.city,
        state: admission?.state ?? student.state,
        pincode: admission?.pincode ?? student.pincode,
        country: admission?.country ?? student.country,
        village: admission?.village ?? null,
        postOffice: admission?.postOffice ?? null,
        policeStation: admission?.policeStation ?? null,
        wardNo: admission?.wardNo ?? null,
        sameAsPermanent: admission?.sameAsPermanent ?? true,
        localAddress: admission?.localAddress ?? null,
        localCity: admission?.localCity ?? null,
        localState: admission?.localState ?? null,
        localPincode: admission?.localPincode ?? null,
        localCountry: admission?.localCountry ?? null,
        localVillage: admission?.localVillage ?? null,
        localPostOffice: admission?.localPostOffice ?? null,
        localPoliceStation: admission?.localPoliceStation ?? null,
        localWardNo: admission?.localWardNo ?? null,
      },
      father: {
