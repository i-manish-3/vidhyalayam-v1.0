...
export function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      try {
        const profile = await api.get<{ user: { id: string; email: string; name: string; role: string; schoolId?: string }; school?: { id: string; name: string; logo?: string; favicon?: string; status: string; academicYear?: string; board?: string; address?: string; city?: string; state: string } }>('/api/auth/me')
        if (profile.school) {
          setCurrentSchool(profile.school as { id: string; name: string; logo?: string; favicon?: string; status: string; academicYear?: string; board?: string; address?: string; city?: string; state: string })
