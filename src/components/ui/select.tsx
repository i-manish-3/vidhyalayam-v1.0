  ...
  return (
    ...
    >
      <span
        ...
        className={cn(
          "flex size-6 shrink-0 items-center justify-center rounded-md bg-gradient-to-br from-primary to-teal-600 text-white shadow-sm [&_svg]:text-white",
          leadingIconClassName
        )}
      >
        {leadingIcon ?? <ListFilterIcon className="size-3.5 text-white" />}
      </span>
      {children}
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-primary/8 focus:text-primary data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-primary/12 data-[state=checked]:to-sky-500/8 data-[state=checked]:font-semibold data-[state=checked]:text-primary [&_svg:not([class*='text-'])]:text-muted-foreground relative flex w-full cursor-default items-center gap-2 rounded-lg py-2 pr-8 pl-2.5 text-sm outline-hidden select-none transition-colors data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className
      )}
      {...props}
    >
