...
export type PageName =
  ...
  | 'attendance' | 'mark-attendance' | 'view-attendance' | 'employee-attendance' | 'attendance-audit-log' | 'attendance-reports' | 'attendance-kiosk' | 'rfid-devices' | 'student-rfid-cards' | 'rfid-card-assign' | 'rfid-audit'
