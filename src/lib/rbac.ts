...
export const DEFAULT_ROLE_TEMPLATES: RoleTemplate[] = [
  ...
  },
  {
    ...
    color: '#14b8a6',
    isSystem: true,
    permissionCodes: ['attendance:read', 'fees:read', 'timetable:read', 'exam:read', 'library:read', 'notification:read', 'announcement:read'],
  },
  {
    name: 'Parent',
    ...
    color: '#f97316',
    isSystem: true,
    permissionCodes: ['student:read', 'attendance:read', 'fees:read', 'notification:read', 'announcement:read', 'exam:read'],
  },
  {
    name: 'Staff',
