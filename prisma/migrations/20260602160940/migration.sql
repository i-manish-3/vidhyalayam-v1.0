...
CREATE TABLE "FeeDemandConfig" (
    ...
    "slipNumberFormat" TEXT NOT NULL DEFAULT 'DS/{academicYear}/{subdomain}/{month}/{sequence}',
...
CREATE TABLE "ExamParadigm" (
    ...
    CONSTRAINT "ExamParadigm_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Exam" (
    ...
    "name" TEXT NOT NULL,
    "shortCode" TEXT,
    "examType" TEXT NOT NULL DEFAULT 'written',
    "startDate" TIMESTAMP(3),
    "endDate" TIMESTAMP(3),
    "status" TEXT NOT NULL DEFAULT 'draft',
    "includeInResult" BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE "ExamSubjectConfig" (
    ...
    "gradeOnly" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "StudentSubjectMapping" (
    ...
    CONSTRAINT "StudentSubjectMapping_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "GradeScale" (
    ...
    "examGroupId" TEXT,
    "classId" TEXT,
    "scaleType" TEXT NOT NULL DEFAULT 'percentage',
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "isDefault" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateTable
CREATE TABLE "ResultSubjectSummary" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "ResultSubjectSummary_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "ExamGroupResult" (
    "id" TEXT NOT NULL,
    "schoolId" TEXT NOT NULL,
    "academicYear" TEXT NOT NULL,
    "examGroupId" TEXT NOT NULL,
    ...
    CONSTRAINT "ExamGroupResult_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ReportCardTemplate" (
    ...
    "name" TEXT NOT NULL,
    "description" TEXT,
    "format" TEXT NOT NULL DEFAULT 'cbse',
    "appliesToParadigmId" TEXT,
    "layoutJson" TEXT NOT NULL,
    "includeAttendance" BOOLEAN NOT NULL DEFAULT true,
    "includeRank" BOOLEAN NOT NULL DEFAULT true,
    "includeCoScholastic" BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE "IdCardTemplate" (
    ...
    "name" TEXT NOT NULL,
    "description" TEXT,
    "templateMode" TEXT NOT NULL DEFAULT 'html',
...
-- CreateIndex
CREATE INDEX "ExamParadigm_schoolId_academicYear_isActive_idx" ON "ExamParadigm"("schoolId", "academicYear", "isActive");

-- CreateIndex
CREATE UNIQUE INDEX "ExamParadigm_schoolId_academicYear_name_key" ON "ExamParadigm"("schoolId", "academicYear", "name");

-- CreateIndex
CREATE INDEX "ExamGroup_schoolId_paradigmId_idx" ON "ExamGroup"("schoolId", "paradigmId");

-- CreateIndex
CREATE INDEX "Exam_schoolId_academicYear_status_idx" ON "Exam"("schoolId", "academicYear", "status");

-- CreateIndex
CREATE INDEX "Exam_parentExamId_idx" ON "Exam"("parentExamId");

-- CreateIndex
CREATE UNIQUE INDEX "Exam_schoolId_academicYear_examGroupId_name_key" ON "Exam"("schoolId", "academicYear", "examGroupId", "name");
...
-- CreateIndex
CREATE INDEX "ExamSubjectConfig_schoolId_examId_idx" ON "ExamSubjectConfig"("schoolId", "examId");

-- CreateIndex
CREATE INDEX "ExamSubjectConfig_schoolId_subjectId_idx" ON "ExamSubjectConfig"("schoolId", "subjectId");

-- CreateIndex
CREATE UNIQUE INDEX "ExamSubjectConfig_examId_classId_subjectId_sectionId_key" ON "ExamSubjectConfig"("examId", "classId", "subjectId", "sectionId");

-- CreateIndex
CREATE INDEX "ExamComponent_subjectConfigId_idx" ON "ExamComponent"("subjectConfigId");

-- CreateIndex
CREATE INDEX "StudentSubjectMapping_schoolId_academicYear_idx" ON "StudentSubjectMapping"("schoolId", "academicYear");

-- CreateIndex
CREATE INDEX "StudentSubjectMapping_studentId_idx" ON "StudentSubjectMapping"("studentId");

-- CreateIndex
CREATE UNIQUE INDEX "StudentSubjectMapping_studentId_academicYear_subjectId_key" ON "StudentSubjectMapping"("studentId", "academicYear", "subjectId");

-- CreateIndex
CREATE INDEX "ExamSchedule_schoolId_examDate_idx" ON "ExamSchedule"("schoolId", "examDate");

-- CreateIndex
CREATE INDEX "ExamSchedule_classId_sectionId_examDate_idx" ON "ExamSchedule"("classId", "sectionId", "examDate");
...
-- CreateIndex
CREATE INDEX "MarksEntry_schoolId_examId_idx" ON "MarksEntry"("schoolId", "examId");

-- CreateIndex
CREATE INDEX "MarksEntry_studentId_idx" ON "MarksEntry"("studentId");

-- CreateIndex
CREATE INDEX "MarksEntry_examId_subjectConfigId_idx" ON "MarksEntry"("examId", "subjectConfigId");

-- CreateIndex
CREATE UNIQUE INDEX "MarksEntry_studentId_subjectConfigId_componentId_key" ON "MarksEntry"("studentId", "subjectConfigId", "componentId");

-- CreateIndex
CREATE INDEX "GradeScale_schoolId_isActive_idx" ON "GradeScale"("schoolId", "isActive");
...
-- CreateIndex
CREATE UNIQUE INDEX "GradeBand_gradeScaleId_code_key" ON "GradeBand"("gradeScaleId", "code");

-- CreateIndex
CREATE INDEX "ExamResult_schoolId_academicYear_idx" ON "ExamResult"("schoolId", "academicYear");

-- CreateIndex
CREATE INDEX "ExamResult_examId_status_idx" ON "ExamResult"("examId", "status");

-- CreateIndex
CREATE UNIQUE INDEX "ExamResult_examId_studentId_key" ON "ExamResult"("examId", "studentId");

-- CreateIndex
CREATE INDEX "ResultSubjectSummary_resultId_idx" ON "ResultSubjectSummary"("resultId");

-- CreateIndex
CREATE INDEX "ExamGroupResult_schoolId_academicYear_idx" ON "ExamGroupResult"("schoolId", "academicYear");

-- CreateIndex
CREATE UNIQUE INDEX "ExamGroupResult_examGroupId_studentId_key" ON "ExamGroupResult"("examGroupId", "studentId");

-- CreateIndex
CREATE INDEX "FinalResult_schoolId_academicYear_promotionStatus_idx" ON "FinalResult"("schoolId", "academicYear", "promotionStatus");

-- CreateIndex
CREATE UNIQUE INDEX "FinalResult_paradigmId_studentId_key" ON "FinalResult"("paradigmId", "studentId");

-- CreateIndex
CREATE INDEX "ReportCardTemplate_schoolId_isActive_idx" ON "ReportCardTemplate"("schoolId", "isActive");

-- CreateIndex
CREATE UNIQUE INDEX "ReportCardTemplate_schoolId_name_key" ON "ReportCardTemplate"("schoolId", "name");

-- CreateIndex
CREATE INDEX "TeacherSubjectAssignment_schoolId_academicYear_idx" ON "TeacherSubjectAssignment"("schoolId", "academicYear");

-- CreateIndex
CREATE INDEX "TeacherSubjectAssignment_teacherId_academicYear_idx" ON "TeacherSubjectAssignment"("teacherId", "academicYear");

-- CreateIndex
CREATE INDEX "TeacherSubjectAssignment_schoolId_classId_sectionId_subject_idx" ON "TeacherSubjectAssignment"("schoolId", "classId", "sectionId", "subjectId");

-- CreateIndex
CREATE UNIQUE INDEX "TeacherSubjectAssignment_schoolId_academicYear_teacherId_cl_key" ON "TeacherSubjectAssignment"("schoolId", "academicYear", "teacherId", "classId", "sectionId", "subjectId");

-- CreateIndex
CREATE INDEX "ExamAuditLog_schoolId_entityType_createdAt_idx" ON "ExamAuditLog"("schoolId", "entityType", "createdAt");

-- CreateIndex
CREATE INDEX "ExamAuditLog_schoolId_examId_createdAt_idx" ON "ExamAuditLog"("schoolId", "examId", "createdAt");

-- CreateIndex
CREATE INDEX "ExamAuditLog_schoolId_studentId_createdAt_idx" ON "ExamAuditLog"("schoolId", "studentId", "createdAt");

-- CreateIndex
CREATE INDEX "ExamAuditLog_schoolId_action_createdAt_idx" ON "ExamAuditLog"("schoolId", "action", "createdAt");

-- CreateIndex
CREATE INDEX "ExamAuditLog_createdAt_idx" ON "ExamAuditLog"("createdAt");
...
-- AddForeignKey
ALTER TABLE "ExamParadigm" ADD CONSTRAINT "ExamParadigm_schoolId_fkey" FOREIGN KEY ("schoolId") REFERENCES "School"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ExamGroup" ADD CONSTRAINT "ExamGroup_paradigmId_fkey" FOREIGN KEY ("paradigmId") REFERENCES "ExamParadigm"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ExamSubjectConfig" ADD CONSTRAINT "ExamSubjectConfig_examId_fkey" FOREIGN KEY ("examId") REFERENCES "Exam"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ExamComponent" ADD CONSTRAINT "ExamComponent_subjectConfigId_fkey" FOREIGN KEY ("subjectConfigId") REFERENCES "ExamSubjectConfig"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "MarksEntry" ADD CONSTRAINT "MarksEntry_subjectConfigId_fkey" FOREIGN KEY ("subjectConfigId") REFERENCES "ExamSubjectConfig"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MarksEntry" ADD CONSTRAINT "MarksEntry_componentId_fkey" FOREIGN KEY ("componentId") REFERENCES "ExamComponent"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ResultSubjectSummary" ADD CONSTRAINT "ResultSubjectSummary_resultId_fkey" FOREIGN KEY ("resultId") REFERENCES "ExamResult"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ExamAuditLog" ADD CONSTRAINT "ExamAuditLog_schoolId_fkey" FOREIGN KEY ("schoolId") REFERENCES "School"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
